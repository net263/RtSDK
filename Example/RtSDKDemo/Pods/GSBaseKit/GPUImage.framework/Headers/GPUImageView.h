...
- (void)GPUImageViewVideoData:(void*)data size:(int)size width:(int)width height:(int)height bytesPerRow:(NSUInteger)bytesPerRow pixelBuffer:(CVPixelBufferRef)pixelBuffer;
@end
